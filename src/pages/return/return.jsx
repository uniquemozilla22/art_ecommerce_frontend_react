            ...
            <div className="container">
                ...
                <h2>Return and Refund</h2>
                    <div className="col-lg-6">
                        <p><b>How to return a Product</b></p>
                        
                        <div className={classes.howtoreturnitem}>
                            <span>1</span>
                    ...
                    <div className="col-lg-6">
                        <div className={classes.refundBox}>
                            <p><b>How to get Refund from a Product?</b></p>
                            <ol>
                            ...
                            <ul className={classes.LinkList}>
                                <li><Link to="./"> Frequntly Asked Questions (FAQ)</Link></li>
